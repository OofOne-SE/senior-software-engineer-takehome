...
// NewGetWsParamsWithHTTPClient creates a new GetWsParams object
// with the default values initialized, and the ability to set a custom HTTPClient for a request
func NewGetWsParamsWithHTTPClient(client *http.Client) *GetWsParams {
...
/*GetWsParams contains all the parameters to send to the API endpoint
for the get ws operation typically these are written to a http.Request
*/
